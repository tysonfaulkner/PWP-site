...
Marcus Sheridan found that the 5 content categories that drive the most traffic, leads, and sales are:

1. **Pricing & Costs** — "How much does X cost?"
2. **Problems & Negatives** — "What are the downsides of X?"
3. **Comparisons** — "X vs Y — which is better?"
4. **Best-of Lists** — "What is the best X?"
5. **Reviews** — "Is X worth it?"

**At least 75% of new content should address these Big 5 topics.** This is where buyers spend their time before making a purchase decision.

### Target Personas

| Persona | Description | Pain Points | Search Behavior |
|---------|-------------|-------------|-----------------|
...
**42 blog posts** across 7 categories:
- Roofing: 11 posts (strongest vertical)
- Management: 7 posts
- Guides: 6 posts
- Manufacturing: 6 posts
- Construction: 5 posts
- Payroll: 3 posts
- Job Costing: 1 post

**20 interactive tools** (calculators and guides):
- Piece Rate Calculator, Payroll Calculator, Job Profit Calculator
- Bid Calculator, Break-Even Calculator, Revenue Calculator
- Overtime Calculator, Labor Burden Calculator, Min Wage Calculator
- 1099 vs W2 Calculator, Workers Comp Estimator, Crew Productivity Calculator
- Roofing Labor Calculator, California Piece Rate Guide, Piece Rate vs Hourly
- Piece Rate Guide, State Minimum Wage, Job Duration Estimator
- Job Site Cost Estimator, Average Job Calculator
...
| # | Article Title | Target Keyword | Funnel Stage |
|---|--------------|----------------|--------------|
| 1 | 7 Common Piece Rate Payroll Mistakes (and How to Avoid Them) | piece rate payroll mistakes | Awareness |
| 2 | The Hidden Risks of Paying Piece Rate Without Tracking Hours | piece rate track hours | Problem-Aware |
| 3 | Why Some Contractors Fail at Implementing Piece Work Software | piece work software problems | Consideration |
| 4 | 5 Ways Piece Rate Pay Can Go Wrong (and How to Fix Each One) | piece rate pay problems | Awareness |
| 5 | How to Avoid FLSA Violations with Piece Rate Workers | FLSA piece rate violations | Problem-Aware |
| 6 | What Happens If You Get Audited for Piece Rate Payroll? | piece rate payroll audit | Problem-Aware |
| 7 | The Biggest Mistake Roofers Make with Piece Rate Overtime | piece rate overtime mistakes roofing | Problem-Aware |
...
| # | Article Title | Target Keyword | Funnel Stage |
|---|--------------|----------------|--------------|
| 1 | Piece Work Pro vs. Spreadsheets: Which Is Better for Tracking Piece Rate Pay? | piece work tracking spreadsheet vs software | Consideration |
| 2 | Piece Rate vs. Hourly Pay in Construction: A Contractor's Guide | piece rate vs hourly construction | Awareness |
| 3 | W-2 Employees vs. 1099 Subcontractors for Piece Work Crews | piece rate w2 vs 1099 | Awareness |
| 4 | QuickBooks vs. Dedicated Piece Work Software for Contractor Payroll | QuickBooks piece rate payroll | Consideration |
| 5 | Piece Rate vs. Hourly: Which Motivates Your Crew More? (Data-Backed) | piece rate vs hourly motivation | Awareness |
| 6 | Piece Rate with Hourly Guarantee vs. Straight Piece Rate: Which Is Better? | piece rate hourly guarantee hybrid | Awareness |
| 7 | ClockShark vs. Piece Work Pro: Which Is Right for Piece Rate Contractors? | ClockShark piece rate | Decision |
...
| # | Article Title | Target Keyword | Funnel Stage |
|---|--------------|----------------|--------------|
| 1 | Best Piece Rate Tracking Software for Contractors (2026) | best piece rate tracking software | Decision |
| 2 | Best Payroll Software for Roofing Contractors (2026) | best roofing payroll software | Decision |
| 3 | Best Payroll Software for Small Construction Companies (2026) | best construction payroll software small | Decision |
| 4 | Best Time Tracking Apps for Construction Crews (2026) | best time tracking app construction | Decision |
| 5 | Best Job Costing Software for Subcontractors (2026) | best job costing software subcontractors | Decision |
...
| # | Article Title | Target Keyword | Funnel Stage |
|---|--------------|----------------|--------------|
| 1 | Is Piece Work Tracking Software Worth It? An Honest Answer | piece work tracking software worth it | Consideration |
| 2 | What Real Roofing Contractors Say About Switching to Piece Rate Software | roofing piece rate software reviews | Decision |
| 3 | Who Should NOT Use Piece Work Pro? (An Honest Assessment) | who is piece work pro for | Decision |
...
|---|--------------|----------------|
| 1 | How to Calculate Overtime for Piece Rate Workers (Step-by-Step) | piece rate overtime calculation |
| 2 | California Piece Rate Law: What Contractors Must Know About AB 1513 | California piece rate law AB 1513 |
| 3 | FLSA Requirements for Piece Rate Employers: A Plain-English Guide | FLSA piece rate requirements |
| 4 | Do You Have to Track Hours If You Pay Piece Rate? | track hours piece rate |
| 5 | Piece Rate Minimum Wage Compliance: How to Make Up the Difference | piece rate minimum wage compliance |
| 6 | How to Pay Piece Rate Workers for Nonproductive Time | nonproductive time piece rate |
| 7 | Piece Rate Pay Stub Requirements: What Must Be on the Check Stub | piece rate pay stub requirements |
| 8 | Are Piece Rate Workers Entitled to Overtime? (Yes — Here's How to Calculate It) | piece rate workers overtime |
| 9 | How to Handle Workers Comp Audits When You Pay Piece Rate | workers comp audit piece rate |
| 10 | Piece Rate Record-Keeping Requirements: What You Must Document | piece rate record keeping |
...
| # | Article Title | Target Keyword |
|---|--------------|----------------|
| 1 | How to Run Piece Rate Payroll Step by Step | how to run piece rate payroll |
| 2 | How to Calculate Labor Burden for Construction Crews | how to calculate labor burden construction |
| 3 | How to Track Piece Work Hours When Your Crew Works Multiple Jobs | track piece work multiple jobs |
| 4 | How to Set Up Piece Rate Pay in Your Payroll System | set up piece rate payroll |
| 5 | How to Do Job Costing for Small Contractors (Step-by-Step) | job costing small contractors |
| 6 | How to Calculate the Regular Rate of Pay for Piece Rate Overtime | regular rate of pay piece rate |
...
| # | Article Title | Target Keyword |
|---|--------------|----------------|
| 1 | Complete Guide to Piece Rate Pay for Drywall Contractors | piece rate drywall contractor |
| 2 | Complete Guide to Piece Rate Pay for Framing Crews | piece rate framing crew |
| 3 | Complete Guide to Piece Rate Pay for Concrete Contractors | piece rate concrete contractor |
...
| # | Article Title | Target Keyword |
|---|--------------|----------------|
| 1 | How to Onboard Piece Rate Crews for the Busy Season | onboard piece rate crews |
| 2 | Pre-Season Payroll Checklist for Contractors | contractor payroll checklist |
| 3 | How to Scale Your Crew from 5 to 25 Without Losing Control | scale construction crew |
| 4 | Year-End Payroll Checklist for Construction Companies | year end payroll construction |
| 5 | How to Keep Your Best Piece Rate Workers from Leaving | retain piece rate workers |
| 6 | How to Handle Slow Season When You Pay Piece Rate | slow season piece rate |
...
| Tool | Supporting Article(s) |
|------|-----------------------|
| Bid Calculator | How Much Should You Mark Up Labor Costs in Construction? |
| Break-Even Calculator | Mid-Year Profit Check: Is Your Crew Making or Losing You Money? |
| Overtime Calculator | How to Calculate Overtime for Piece Rate Workers (Step-by-Step) |
| Labor Burden Calculator | What Does a Fully Burdened Labor Rate Really Cost in Construction? |
| Workers Comp Estimator | How Much Does Workers Comp Cost for Roofing Contractors? |
| Min Wage Calculator | Piece Rate Minimum Wage Compliance: How to Make Up the Difference |
| 1099 vs W2 Calculator | W-2 Employees vs. 1099 Subcontractors for Piece Work Crews |
| Crew Productivity Calculator | How to Keep Your Best Piece Rate Workers from Leaving |
| Revenue Calculator | How to Calculate Job Profitability for Every Project |
| Job Duration Estimator | How to Scale Your Crew from 5 to 25 Without Losing Control |
| Job Site Cost Estimator | How Much Does It Actually Cost to Hire a Construction Employee? |
| Average Job Calculator | Mid-Year Profit Check: Is Your Crew Making or Losing You Money? |

Every article should include a CTA like: *"Want to run these numbers for your crew? Try our free [Tool Name] — no signup required."*
...
- How does it handle overtime calculations?
...
### Pre-Demo Content Sequence

When a prospect signs up for a trial or requests a demo, send them this content in this order:
...
| Prospect Objection | Send This Article |
|--------------------|-------------------|
| "What does it cost?" | How Much Does Piece Work Tracking Software Cost? |
| "My crews won't use an app" | Do Your Crews Actually Need an App? |
| "Spreadsheets work fine" | Piece Work Pro vs. Spreadsheets |
| "I'm worried about overtime compliance" | How to Calculate Overtime for Piece Rate Workers |
...
/blog/piece-rate-pay/          (Hub: Everything about piece rate pay)
  ├── /blog/piece-rate-overtime-calculation
  ├── /blog/piece-rate-minimum-wage-compliance
  ├── /blog/flsa-piece-rate-requirements
  ├── /blog/california-piece-rate-law
  └── ... (all compliance + piece rate articles)

/blog/construction-payroll/     (Hub: Construction payroll guides)
  ├── /blog/how-to-run-piece-rate-payroll
  ├── /blog/construction-payroll-beginners
  ├── /blog/multi-state-construction-payroll
  └── ... (all payroll articles)

/blog/job-costing/              (Hub: Job costing for contractors)
  ├── /blog/job-costing-small-contractors
  ├── /blog/fully-burdened-labor-rate-construction
  ├── /blog/construction-labor-markup
  └── ... (all job costing articles)
...
|--------|-----------------|
| Keyword rankings for Big 5 topics | Ahrefs or Semrush (weekly) |
| Blog-to-tool click-through rate | Google Analytics events |
| Tool-to-signup conversion rate | Google Analytics funnel |
| Organic traffic value (equivalent PPC cost) | Ahrefs |
| Backlinks earned from content | Ahrefs |
| Email subscriber growth from blog CTAs | Email platform |
| Search impressions and CTR | Google Search Console |

### Monthly Content Scorecard

Track for every article published:
- Organic sessions (30/60/90 day)
- Rankings achieved (which keywords, what position)
- Tool clicks generated
...
| Competitor | Content Strength | Piece Rate Focus | Our Advantage |
|-----------|-----------------|-------------------|---------------|
| Workyard | Strong SEO play, ranks for construction payroll terms | Has 1 piece rate guide | We go 10x deeper on piece rate |
| ClockShark | Good time tracking content | Minimal piece rate coverage | We own the niche they ignore |
...
[Opening paragraph: Answer the question directly in 40-60 words.
This is your featured snippet bid.]

## Table of Contents (for articles 2,000+ words)

## H2 Section (target keyword variation)

[2-4 paragraphs of real-world advice. Write like you're
talking to a contractor, not a search engine.]

### H3 Subsection (if needed)

## [Another H2 Section]

## Real-World Example / Worked Calculation
[Show actual numbers. Contractors respond to math, not theory.]

## Common Mistakes to Avoid
[This section converts well and earns featured snippets.]

## FAQ Section (3-5 questions)
[Use FAQ schema markup. Each answer 40-80 words.]

## Bottom CTA
"Want to run these numbers for your crew?
Try our free [Tool Name] — no signup required."
[Link to relevant calculator/tool]

---
### Internal Links Checklist:
- [ ] Links to at least 1 tool page
- [ ] Links to at least 2 other blog posts
- [ ] Links to 1 feature page (payroll, time-tracking, or job-costing)
```

### Writing Voice Guidelines

- **Write like Tyson talks.** First person. "When I was running roofing crews..." beats "Contractors should consider..."
- **Use real numbers.** "$8.50 per square for tear-off and install" beats "a fair piece rate."
- **No jargon without explanation.** If you use "labor burden," explain it immediately.
...
Every long-form article (1,500+ words) should be broken into:
1. **1 LinkedIn post** (key insight + link)
2. **1 email snippet** (for the weekly newsletter)
3. **3-5 social media quotes** (pull stats, key sentences, or bold claims)
4. **1 short video script** (for future YouTube Shorts / social clips)
...
### Overlap Check: Existing Posts vs. Planned Articles

These planned articles overlap with existing posts and should be **updates to existing URLs** (not new posts) to preserve any existing SEO equity:

| Planned Article | Existing Post to Update |
|-----------------|-------------------------|
| Piece Rate vs. Hourly: Which Motivates Your Crew More? (Data-Backed) | piece-work-vs-hourly-pay-which-is-more-motivational.mdx |
| How Much to Pay Roofing Crews Per Square (2026 Rate Guide) | how-much-to-pay-per-square-in-roofing.mdx |
| 7 Common Piece Rate Payroll Mistakes | top-5-mistakes-businesses-make-when-shifting-to-piece-work.mdx (expand) |

All other planned articles are net-new content.
...
- **Definition questions:** Answer in 40-60 words in the first paragraph
- **How-to questions:** Use numbered steps with `<ol>` markup
...
1. **Answer every question honestly.** Even uncomfortable ones about pricing, problems, and competitors. Trust is the goal.

2. **75% Big 5 content.** Pricing, problems, comparisons, best-of, reviews. This is what buyers actually search for.

3. **Every article serves a calculator.** The 20 free tools are your lead generation engine. Every article should drive traffic to at least one.
