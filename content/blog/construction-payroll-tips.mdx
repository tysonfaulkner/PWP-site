...
**The fix:** Track hours and piece work earnings side by side. If someone's piece rate earnings divided by hours worked falls below minimum wage, you need to make up the difference. Use our [minimum wage compliance checker](/tools/min-wage-calculator) to verify your rates. Your payroll system should flag this automatically.
...
[Construction](/industries/construction) payroll does not have to be a Friday night headache. The key is capturing good data in the field, linking it to projects, automating the calculations, and reviewing before you pay. Piece Work Pro's [payroll reports](/features/payroll) make this easy. Get those four things right and payroll becomes the easiest part of your week.
